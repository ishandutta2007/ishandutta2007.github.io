...
```yml
# Site settings
title: Ishan Blog             # title of your website
SEOTitle: Ishan Blog          # check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“Ishan Blog”** but I want the title shows in search engine is **“黄玄的博客 | Ishan Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/Ishanpro/huxpro.github.io/issues/15) about code wrap.
