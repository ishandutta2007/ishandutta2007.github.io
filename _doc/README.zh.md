...
```
$ git clone git@github.com:Ishanpro/huxblog-boilerplate.git
```
...
* 解决了代码过长自动换行的bug,替换为横向滚动条。详情请见[issue#15](https://github.com/Ishanpro/huxpro.github.io/issues/15)
...
```
# Site settings
title: Ishan Blog             # 你的博客网站标题
SEOTitle: Ishan Blog			# 在后面会详细谈到
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/Ishanpro/huxpro.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
...
我的博客标题是 **“Ishan Blog”** 但是我想要在搜索的时候显示 **“黄玄的博客 | Ishan Blog”** ，这个就需要SEO Title来定义了。
